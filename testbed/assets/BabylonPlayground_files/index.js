(function () {
    ...
    ], function (Platform, ModesExt, Network, Services) {
        Platform.Registry.as(ModesExt.Extensions.EditorModes).configureMode('text/javascript', {
            "validationSettings": {
                "extraLibs": ["../../../../babylon.d.txt"],
            }
        });
        Platform.Registry.as(ModesExt.Extensions.EditorModes).registerWorkerParticipant('vs.languages.javascript',
            new Services.AsyncDescriptor('../../../privateFilter', 'PrivateFilter'));
    });
